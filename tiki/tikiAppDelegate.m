...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIViewController *viewController2 = [[tikiRootViewController alloc] initWithNibName:@"tikiRootViewController" bundle:nil];
    UIViewController *viewController1 = [[tikiSecondViewController alloc] initWithNibName:@"tikiSecondViewController" bundle:nil];
    
    UIImage *navigationBarBackground = [UIImage imageNamed:@"topBar"];
